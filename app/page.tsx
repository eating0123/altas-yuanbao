  ...
  return (
    <main>
      <header className="site-header">
        ...
        <button className="mode-button" onClick={() => setShowSettings(true)}>
          <span className="live-dot" /> 主动程度 · {mode}
        </button>
      </header>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <button className="primary-button" onClick={startDemo}>
              模拟一次重逢 <Arrow />
            </button>
      ...
      <footer>
        ...
        <button onClick={() => { selectScene("cafe"); startDemo(); }}>
          回到第一个锚点 ↗
        </button>
      </footer>
